 ...
 * @author alessandra
 */
public class CadastroGrupoUsuario extends javax.swing.JFrame {

    private final GrupoUsuarioTableModel model;
    private final GrupoUsuarioController controle;
    private final GrupoUsuarioMediator mediator;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Grupo de Usuario");
        ...
        tabela.setMaximumSize(new java.awt.Dimension(500, 500));
        tabela.setMinimumSize(new java.awt.Dimension(300, 300));
        tabela.setName(""); // NOI18N
        tabela.setPreferredSize(new java.awt.Dimension(600, 600));
        ...
        tab.addTab("Consultar Grupo", jPanel5);
        ...
        jLabel13.setText("Nome Grupo de Usuário:");
        ...
        jPanel10.setBackground(new java.awt.Color(121, 214, 183));
        ...
        tab.addTab("Cadastrar Grupo", jPanel4);
...
//            Logger.getLogger(CadastroGrupoUsuario.class.getName()).log(Level.SEVERE, null, ex);
//        }
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroGrupoUsuario().setVisible(true);
            }
        });
    }
