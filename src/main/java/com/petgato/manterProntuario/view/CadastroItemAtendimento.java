...
import com.petgato.manterProntuario.mediator.ItemAtendimentoMediator;
 ...
 * @author alessandra
 */
public class CadastroItemAtendimento extends javax.swing.JFrame {

    private final ItemAtendimentoTableModel model;
    private final ItemAtendimentoController controle;
    private final ItemAtendimentoMediator mediator;

    /**
     * Creates new form CadastroUsuario
     */
    public CadastroItemAtendimento() {
        model = new ItemAtendimentoTableModel();
        controle = new ItemAtendimentoController();

        initComponents();

        mediator = new ItemAtendimentoMediator();
        mediator.registerTxtId(txtId)
                .registerTxtQuantidade(txtQuantidade)
    ...
    private void initComponents() {
        ...
        tab.addTab("Consultar Item Atendimento", jPanel5);
        ...
        tab.addTab("Cadastrar Item Atendimento", jPanel4);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroItemAtendimento().setVisible(true);
            }
